...
local function run(msg, matches)
  if matches[1]:lower() == 'radical' then -- Put everything you like :)
    local about = _config.about_text
    local name = user_print_name(msg.from)
    savelog(msg.to.id, name.." ["..msg.from.id.."] used /radical ")
    return about
  end 
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "radical" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tats) (group) (%d+)",
    "^([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (radical)",-- Put everything you like :)
    "^([Ss]tats) (radical)",-- Put everything you like :)
		"^[!/]([Rr]adical)",-- Put everything you like :)
		"^([Rr]adical)"-- Put everything you like :)
    }, 
  run = run
}
